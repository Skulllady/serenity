...
7. Push your docker container to heroku from the root directory of your project.
   ...
   ```bash
   heroku container:push web -a serenity--app
   ```

8. Release your docker container to heroku

   ```bash
   heroku container:release web -a serenity--app
   ```

9. set up your database:

   ```bash
   heroku run -a serenity--app flask db upgrade
   heroku run -a serenity--app flask seed all
   ```
