...
def seed_transactions():
    ...
    t16 = Transaction(date=20210813, transaction="Transfer to savings", amount=2888.25, account_id=2, category_id=12)
    t16 = Transaction(date=20210901, transaction="Transfer to savings", amount=3000.15, account_id=2, category_id=12)
    t17 = Transaction(date=20210905, transaction="Student Loan", amount=-13000, account_id=3, category_id=13)
    t18 = Transaction(date=20210915, transaction="401K Account", amount=15000, account_id=4, category_id=14)
